...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
	<head>
    	...
    	<script type="text/javascript"
      		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCoWz18DcPRiE7yGoTpQ7ix3CNhUiWXHes&sensor=false">
    	</script>
    	...
    	//initialisation de la map		
      	...
      	//coordonnées de la ville Orléans
      	  /*<c:forEach items="${reseau}" var="reseau">	 
		  	var latReseau = '<c:out value="${reseau.latitude}"/>';
		  	var lngReseau = '<c:out value="${reseau.longitude}"/>';
		  </c:forEach>
		  var centerMap = new google.maps.LatLng(latReseau, lngReseau);*/
          var centerMap = new google.maps.LatLng(47.904, 1.907);
		...
		/*Récupération des données des stations*/
    	  ...
    	  function effacerMarker() {
    		  
    	  }
    	  
    	  function changerEtatTrain() {
		...
		<table id="RnoPage" class="RnoLayout-1col">
			<tr>
				<td id="RnoPageWidthRange">
					...
					<!-- /Page Header --> 
					<jsp:include page="menuVisualisation.jsp"/> 
