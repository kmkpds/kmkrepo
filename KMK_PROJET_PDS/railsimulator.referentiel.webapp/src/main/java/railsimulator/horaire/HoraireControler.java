...
//			train3 = trainDAO.getTrainByID(idTrain3);
			...
			station1 = stationDAO.getStationByID(idStation1);
				trainHoraireStationDAO.createTrainHoraire("8:00", "9:00", "10:00", station1, trainDAO.getTrainByID(idTrain1));
				trainHoraireStationDAO.createTrainHoraire("8:05", "9:07", "10:10", station1, trainDAO.getTrainByID(idTrain2));
				trainHoraireStationDAO.createTrainHoraire("8:10", "9:14", "10:20", station1, trainDAO.getTrainByID(idTrain3));
			...
			station2 = stationDAO.getStationByID(idStation2);
				trainHoraireStationDAO.createTrainHoraire("8:07", "9:05", "10:10", station2, trainDAO.getTrainByID(idTrain1));
				trainHoraireStationDAO.createTrainHoraire("8:12", "9:12", "10:20", station2, trainDAO.getTrainByID(idTrain2));
				trainHoraireStationDAO.createTrainHoraire("8:17", "9:19", "10:30", station2, trainDAO.getTrainByID(idTrain3));
			...
			station3 = stationDAO.getStationByID(idStation3);
				trainHoraireStationDAO.createTrainHoraire("8:25", "9:25", "10:20", station3, trainDAO.getTrainByID(idTrain1));
				trainHoraireStationDAO.createTrainHoraire("8:30", "9:30", "10:30", station3, trainDAO.getTrainByID(idTrain2));
				trainHoraireStationDAO.createTrainHoraire("8:35", "9:35", "10:40", station3, trainDAO.getTrainByID(idTrain3));
			...
			station4 = stationDAO.getStationByID(idStation4);
				trainHoraireStationDAO.createTrainHoraire("8:37", "9:40", "10:30", station4, trainDAO.getTrainByID(idTrain1));
				trainHoraireStationDAO.createTrainHoraire("8:42", "9:47", "10:40", station4, trainDAO.getTrainByID(idTrain2));
				trainHoraireStationDAO.createTrainHoraire("8:47", "9:54", "10:50", station4, trainDAO.getTrainByID(idTrain3));
			...
			station5 = stationDAO.getStationByID(idStation5);
				trainHoraireStationDAO.createTrainHoraire("8:50", "10:00", "10:40", station5, trainDAO.getTrainByID(idTrain1));
				trainHoraireStationDAO.createTrainHoraire("8:55", "10:07", "10:50", station5, trainDAO.getTrainByID(idTrain2));
				trainHoraireStationDAO.createTrainHoraire("9:00", "10:15", "11:00", station5, trainDAO.getTrainByID(idTrain3));
			...
			station6 = stationDAO.getStationByID(idStation6);
				trainHoraireStationDAO.createTrainHoraire("06:00", "07:30", "08:00", station6, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:03:30", "07:35:00", "08:10", station6, trainDAO.getTrainByID(idTrain5));
				trainHoraireStationDAO.createTrainHoraire("22:00:00", "22:50:00", "22:33:00", station6, trainDAO.getTrainByID(idTrain6));				
				trainHoraireStationDAO.createTrainHoraire("06:46:12", "08:23:12", "09:07:12", station6, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:49:42", "08:21:12", "08:56:12", station6, trainDAO.getTrainByID(idTrain8));
			...
			station7 = stationDAO.getStationByID(idStation7);	
				trainHoraireStationDAO.createTrainHoraire("06:02:56", "07:33:26", "08:04:26", station7, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:06:26", "07:37:56", "08:12:56", station7, trainDAO.getTrainByID(idTrain5));
				trainHoraireStationDAO.createTrainHoraire("22:02:56", "22:53:26", "22:37:26", station7, trainDAO.getTrainByID(idTrain6));				
				trainHoraireStationDAO.createTrainHoraire("06:43:16", "08:19:46", "09:02:46", station7, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:46:46", "08:18:16", "08:53:16", station7, trainDAO.getTrainByID(idTrain8));
			...
			station8 = stationDAO.getStationByID(idStation8);
				trainHoraireStationDAO.createTrainHoraire("06:06:50", "07:37:50", "08:09:50", station8, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:10:20", "07:41:50", "08:16:50", station8, trainDAO.getTrainByID(idTrain5));
				trainHoraireStationDAO.createTrainHoraire("22:06:50", "22:57:50", "22:42:50", station8, trainDAO.getTrainByID(idTrain6));				
				trainHoraireStationDAO.createTrainHoraire("06:39:22", "08:15:22", "08:57:22", station8, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:42:52", "08:14:22", "08:49:22", station8, trainDAO.getTrainByID(idTrain8));
			...
			station9 = stationDAO.getStationByID(idStation9);								
				trainHoraireStationDAO.createTrainHoraire("06:10:16", "07:41:46", "08:14:46", station9, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:13:46", "07:45:16", "08:20:16", station9, trainDAO.getTrainByID(idTrain5));
				trainHoraireStationDAO.createTrainHoraire("22:10:16", "23:01:46", "22:47:46", station9, trainDAO.getTrainByID(idTrain6));				
				trainHoraireStationDAO.createTrainHoraire("06:35:56", "08:11:26", "08:52:26", station9, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:39:26", "08:10:56", "08:45:56", station9, trainDAO.getTrainByID(idTrain8));
			...
			station10 = stationDAO.getStationByID(idStation10);		
				trainHoraireStationDAO.createTrainHoraire("06:13:55", "07:45:55", "08:19:55", station10, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:17:25", "07:48:55", "08:23:55", station10, trainDAO.getTrainByID(idTrain5));
				trainHoraireStationDAO.createTrainHoraire("22:13:55", "23:05:55", "22:52:55", station10, trainDAO.getTrainByID(idTrain6));
				trainHoraireStationDAO.createTrainHoraire("06:32:17", "08:07:17", "08:47:17", station10, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:35:47", "08:07:17", "08:42:17", station10, trainDAO.getTrainByID(idTrain8));
			...
			station11 = stationDAO.getStationByID(idStation11);					
				trainHoraireStationDAO.createTrainHoraire("06:18:04", "07:50:34", "08:25:34", station11, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:21:34", "07:53:04", "08:28:04", station11, trainDAO.getTrainByID(idTrain5));
				trainHoraireStationDAO.createTrainHoraire("22:18:04", "23:10:34", "22:58:34", station11, trainDAO.getTrainByID(idTrain6));
				trainHoraireStationDAO.createTrainHoraire("06:28:08", "08:02:38", "08:41:38", station11, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:31:38", "08:03:08", "08:38:08", station11, trainDAO.getTrainByID(idTrain8));
			...
			station12 = stationDAO.getStationByID(idStation12);	
				trainHoraireStationDAO.createTrainHoraire("06:21:00", "07:54:00", "08:30:00", station12, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:24:30", "07:56:00", "08:31:00", station12, trainDAO.getTrainByID(idTrain5));
				trainHoraireStationDAO.createTrainHoraire("22:21:00", "23:14:00", "23:03:00", station12, trainDAO.getTrainByID(idTrain6));
				trainHoraireStationDAO.createTrainHoraire("06:25:12", "07:59:12", "08:37:12", station12, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:28:42", "08:00:12", "08:35:12", station12, trainDAO.getTrainByID(idTrain8));
			...
			station13 = stationDAO.getStationByID(idStation13);	
				trainHoraireStationDAO.createTrainHoraire("06:23:28", "07:56:58", "08:33:58", station13, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:26:58", "07:58:28", "08:33:28", station13, trainDAO.getTrainByID(idTrain5));
//				trainHoraireStationDAO.createTrainHoraire("22:23:28", "23:16:58", "", station13, train6);
				trainHoraireStationDAO.createTrainHoraire("06:22:44", "07:56:14", "08:33:14", station13, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:26:14", "07:57:44", "08:32:44", station13, trainDAO.getTrainByID(idTrain8));
//				trainHoraireStationDAO.createTrainHoraire("", "23:22:44", "22:57:44", station13, train9);
			...
			station14 = stationDAO.getStationByID(idStation14);	
				trainHoraireStationDAO.createTrainHoraire("06:26:24", "08:00:24", "08:38:24", station14, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:29:54", "08:01:24", "08:36:24", station14, trainDAO.getTrainByID(idTrain5));
//				trainHoraireStationDAO.createTrainHoraire("22:26:24", "23:20:24", "", station14, train6);
				trainHoraireStationDAO.createTrainHoraire("06:19:48", "07:52:48", "08:28:48", station14, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:23:18", "07:54:48", "08:29:48", station14, trainDAO.getTrainByID(idTrain8));
//				trainHoraireStationDAO.createTrainHoraire("", "23:19:48", "22:54:48", station14, train9);
			...
			station15 = stationDAO.getStationByID(idStation15);	
				trainHoraireStationDAO.createTrainHoraire("06:29:35", "08:04:05", "08:43:05", station15, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:33:05", "08:04:35", "08:39:35", station15, trainDAO.getTrainByID(idTrain5));
//				trainHoraireStationDAO.createTrainHoraire("22:29:35", "23:24:05", "", station15, train6);					
				trainHoraireStationDAO.createTrainHoraire("06:16:37", "07:49:07", "08:24:07", station15, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:20:07", "07:51:37", "08:26:37", station15, trainDAO.getTrainByID(idTrain8));
			...
			station16 = stationDAO.getStationByID(idStation16);	
				trainHoraireStationDAO.createTrainHoraire("06:33:58", "08:08:58", "08:43:58", station16, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:37:28", "08:08:58", "08:36:24", station16, trainDAO.getTrainByID(idTrain5));
//				trainHoraireStationDAO.createTrainHoraire("22:33:58", "23:28:58", "", station16, train6);	
				trainHoraireStationDAO.createTrainHoraire("06:12:14", "07:44:14", "08:22:14", station16, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:15:44", "07:47:14", "08:29:48", station16, trainDAO.getTrainByID(idTrain8));
			...
			station17 = stationDAO.getStationByID(idStation17);
				trainHoraireStationDAO.createTrainHoraire("06:37:52", "08:13:22", "08:54:22", station17, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:41:22", "08:12:52", "08:47:52", station17, trainDAO.getTrainByID(idTrain5));
//				trainHoraireStationDAO.createTrainHoraire("", "23:33:22", "", station17, train6);	
				trainHoraireStationDAO.createTrainHoraire("06:08:20", "07:39:50", "08:12:50", station17, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:11:50", "07:43:20", "08:18:20", station17, trainDAO.getTrainByID(idTrain8));
			...
			station18 = stationDAO.getStationByID(idStation18);	
				trainHoraireStationDAO.createTrainHoraire("06:41:02", "08:17:02", "08:59:02", station18, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:44:32", "08:16:02", "08:51:02", station18, trainDAO.getTrainByID(idTrain5));
				//trainHoraireStationDAO.createTrainHoraire("", "", "", station14, train6);											
				trainHoraireStationDAO.createTrainHoraire("06:05:10", "07:36:10", "08:08:10", station18, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:08:40", "07:40:10", "08:15:10", station18, trainDAO.getTrainByID(idTrain8));
			...
			station19 = stationDAO.getStationByID(idStation19);			
				trainHoraireStationDAO.createTrainHoraire("06:43:44", "08:20:14", "09:03:14", station19, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:47:14", "08:18:44", "08:53:44", station19, trainDAO.getTrainByID(idTrain5));
				//trainHoraireStationDAO.createTrainHoraire("", "", "", station19, train6);						
				trainHoraireStationDAO.createTrainHoraire("06:02:28", "07:32:58", "08:03:58", station19, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:05:58", "07:37:28", "08:12:28", station19, trainDAO.getTrainByID(idTrain8));
			...
			station20 = stationDAO.getStationByID(idStation20);				
				trainHoraireStationDAO.createTrainHoraire("06:46:12", "08:23:12", "09:07:12", station20, trainDAO.getTrainByID(idTrain4));
				trainHoraireStationDAO.createTrainHoraire("06:49:42", "08:21:12", "08:56:12", station20, trainDAO.getTrainByID(idTrain5));
				//trainHoraireStationDAO.createTrainHoraire("", "", "", station20, train6);
				trainHoraireStationDAO.createTrainHoraire("06:00:00", "07:30:00", "08:00:00", station20, trainDAO.getTrainByID(idTrain7));
				trainHoraireStationDAO.createTrainHoraire("06:03:30", "07:35:00", "08:10:00", station20, trainDAO.getTrainByID(idTrain8));
