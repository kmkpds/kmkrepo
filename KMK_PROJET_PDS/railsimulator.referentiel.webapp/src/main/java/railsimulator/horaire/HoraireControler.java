...
//			request.setAttribute("Parametres", parametreHoraire);
		...
		if(action.equals("Mock")){
			...
			//Création Station
			int idStation1 = stationDAO.createStationReturnId("Station test 1", "Commentaire test", 47.91472925167114, 1.8781471252441406,34, ligne);
			...
			int idStation2 = stationDAO.createStationReturnId("Station test 2", "Commentaire test", 47.9106175347537, 1.869049072265625, 43,ligne);
			...
			int idStation3 = stationDAO.createStationReturnId("Station test 3", "Commentaire test", 47.91849873298912, 1.8872451782226562,45, ligne);
			...
			int idStation4 = stationDAO.createStationReturnId("Station test 4", "Commentaire test", 47.91472925167114, 1.9353961944580078,35, ligne);
			...
			int	idStation5 = stationDAO.createStationReturnId("Station test 5", "Commentaire test", 47.91455813387141, 1.8781471252441406,45,ligne);
			...
			int	idStation6 = stationDAO.createStationReturnId("Station test 6", "Commentaire test", 47.9106175347537, 1.869049072265625, 32,ligne2);
			...
			int	idStation7 = stationDAO.createStationReturnId("Station test 7", "Commentaire test", 47.91849873298912, 1.8872451782226562,32, ligne2);
			...
			int	idStation8 = stationDAO.createStationReturnId("Station test 8", "Commentaire test", 47.91472925167114, 1.9353961944580078,43, ligne2);
			...
			int	idStation9 = stationDAO.createStationReturnId("Station test 9", "Commentaire test", 47.91455813387141, 1.8781471252441406,45, ligne2);
			...
			int	idStation10 = stationDAO.createStationReturnId("Station test 10", "Commentaire test", 47.9106175347537, 1.869049072265625,45, ligne2);
			...
			int	idStation11 = stationDAO.createStationReturnId("Station test 11", "Commentaire test", 47.91849873298912, 1.8872451782226562,43, ligne2);
			...
			int	idStation12 = stationDAO.createStationReturnId("Station test 12", "Commentaire test", 47.91849874318824, 1.8872451782235675,46, ligne2);
			...
			int	idStation13 = stationDAO.createStationReturnId("Station test 13", "Commentaire test", 47.91849874318925, 1.887245178223765,67, ligne2);
...
//				trainHoraireStationDAO.createTrainHoraire("", "23:22:44", "22:57:44", station13, train9);
			int	idStation14 = stationDAO.createStationReturnId("Station test 14", "Commentaire test", 47.91849874321045, 1.8872451782236457,78, ligne2);
...
//				trainHoraireStationDAO.createTrainHoraire("", "23:19:48", "22:54:48", station14, train9);
			int	idStation15 = stationDAO.createStationReturnId("Station test 15", "Commentaire test", 47.91849874318869, 1.8872451782235778,46, ligne2);
...
//				trainHoraireStationDAO.createTrainHoraire("22:29:35", "23:24:05", "", station15, train6);					
			...
			int	idStation16 = stationDAO.createStationReturnId("Station test 16", "Commentaire test", 47.91849874318911, 1.8872451782236545, 76,ligne2);
...
//				trainHoraireStationDAO.createTrainHoraire("22:33:58", "23:28:58", "", station16, train6);	
			...
			int	idStation17 = stationDAO.createStationReturnId("Station test 17", "Commentaire test", 47.91849874318984, 1.8872451782236640,47, ligne2);
...
//				trainHoraireStationDAO.createTrainHoraire("", "23:33:22", "", station17, train6);	
			...
			int	idStation18 = stationDAO.createStationReturnId("Station test 18", "Commentaire test", 47.91849874319034, 1.8872451782236770, 32,ligne2);
			...
			int	idStation19 = stationDAO.createStationReturnId("Station test 19", "Commentaire test", 47.91849874319150, 1.8872451782236950,43, ligne2);
			...
			int	idStation20 = stationDAO.createStationReturnId("Station test 20", "Commentaire test", 47.91849874319240, 1.8872451782237050, 54,ligne2);
