...
public class StationDAOTest extends TestCase {
		...
		public void testlisterStationHasStationByListStation() throws SQLException{
			...
			//Récupération de la liste de ligne par la méthode listerLigne
			listeStation2= station_dao.listerStationHasStationByListStation(stationList);

			//Vérification du nombre de résultat (2)
			if (listeStation2.length==2){
//				//Vérification des données récupérées
//				if(listeStation2.get(0).getNomStation().equals("Station Alpha2") && listeStation2.get(0).getCommentaireStation().equals("Station Alpha2")
//						&& listeStation2.get(0).getLatitude() == 55.5 && listeStation2.get(0).getLongitude() == 55.5
//						&& listeStation2.get(1).getNomStation().equals("Station Beta2") && listeStation2.get(1).getCommentaireStation().equals("Station Beta2")
//						&& listeStation2.get(1).getLatitude() == 55.5 && listeStation2.get(1).getLongitude() == 55.5){
